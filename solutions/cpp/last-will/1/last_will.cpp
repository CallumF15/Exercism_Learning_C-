...
namespace estate_executor
{
    ...
    {
        int sum = garcia::bank_number_part(secret_modifier) + 
    ...
    int assemble_code(){
        ...
        int blueCode = (garcia::blue::code_fragment() + khan::blue::code_fragment() + zhang::blue::code_fragment());
        int combinedCode = redCode * blueCode;
